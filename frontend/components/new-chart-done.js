...
import { Bar, Line, Scatter, Bubble, PolarArea, Radar } from "react-chartjs-2";

import Chart from "chart.js/auto";

const NewChartDone = ({ data }) => {

    const handleSave = () => {
        fetch(`${process.env.NEXT_PUBLIC_FRONTEND_ADAPTER}/uploadAndCreateChart/`);
    };
